...
\title{B9AI105 RL CA1(60\%): Deep Reinforcement Learning Concepts Project}
...
\section*{Objective}
Develop a comprehensive understanding of key concepts in deep reinforcement learning (DRL) and algorithms used in DRL, with a practical implementation in a suitable environment of your choice. This may include OpenAI Gym environments such as CartPole, MountainCar, LunarLander, or a custom-built environment tailored to your project goals.
...
\begin{itemize}
    ...
    \item Make sure to submit this assignment by \textbf{7th of July 2025}
\end{itemize}
